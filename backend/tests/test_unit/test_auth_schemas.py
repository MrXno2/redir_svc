...
class TestAuthRegisterSchema:
    def test_valid_data(self):
        schema = AuthRegisterShema(login="testuser", password1="pass123", password2="pass123")
    ...
    def test_passwords_mismatch(self):
        with pytest.raises(ValidationError, match="Пароли не совпадают"):
            AuthRegisterShema(login="testuser", password1="pass123", password2="pass456")
    ...
    def test_login_special_chars(self):
        with pytest.raises(ValidationError):
            AuthRegisterShema(login="test@user", password1="pass123", password2="pass123")

    def test_login_with_underscores(self):
        with pytest.raises(ValidationError):
            AuthRegisterShema(login="test_user", password1="pass123", password2="pass123")
    ...
    def test_password_with_spaces(self):
        with pytest.raises(ValidationError):
            AuthRegisterShema(login="testuser", password1="pass word", password2="pass word")
